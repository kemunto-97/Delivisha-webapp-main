						...
						<div class="card dlab-join-card h-auto">
							<div class="card-body">
								<div class="dlab-media d-flex justify-content-between">
									...
									<div class="dlab-img">
										<img src="<?= site_url() ?>public/assets/images/egucation-girl.png" alt="">
									</div>
									<div class="dlab-icon">
										<img src="<?= site_url() ?>public/assets/images/vector/calpng.png" alt="" class="cal-img">
										<img src="<?= site_url() ?>public/assets/images/vector/book.png" alt="" class="book-img">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-xl-4 col-sm-6">
								<div class="dlab-cource bg-secondary">
									...
									<img src="<?= site_url() ?>public/assets/images/vector/check.png" alt="">
								</div>
							</div>
							<div class="col-xl-4 col-sm-6">
								<div class="dlab-cource">
									...
									<img src="<?= site_url() ?>public/assets/images/vector/bookmarks.png" class="bookmarks" alt="">
								</div>
							</div>
							<div class="col-xl-4 col-sm-12">
								<div class="dlab-cource bg-primary">
									...
									<img src="<?= site_url() ?>public/assets/images/vector/bulb.png" class="bulb" alt="">
								</div>
							</div>
						</div>
					</div>
