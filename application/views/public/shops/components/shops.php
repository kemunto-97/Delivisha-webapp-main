			...
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course1.jpg" alt="">
					</div>
					<div class="dlab-info">
						...
						<div class="d-flex justify-content-between content align-items-center">
							...
							<a href="courses.html" class="btn btn-primary btn-sm nav-button">View Shop</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="col-xl-4 col-md-6">
		<div class="card all-crs-wid">
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course2.jpg" alt="">
					</div>
					<div class="dlab-info">
						<div class="dlab-title d-flex justify-content-between">
							<div>
	...
	<div class="col-xl-4 col-md-6">
		<div class="card all-crs-wid">
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course3.jpg" alt="">
					</div>
					<div class="dlab-info">
						<div class="dlab-title d-flex justify-content-between">
							<div>
	...
	<div class="col-xl-4 col-md-6">
		<div class="card all-crs-wid">
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course4.jpg" alt="">
					</div>
					<div class="dlab-info">
						<div class="dlab-title d-flex justify-content-between">
							<div>
	...
	<div class="col-xl-4 col-md-6">
		<div class="card all-crs-wid">
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course5.jpg" alt="">
					</div>
					<div class="dlab-info">
						<div class="dlab-title d-flex justify-content-between">
							<div>
	...
	<div class="col-xl-4 col-md-6">
		<div class="card all-crs-wid">
			<div class="card-body" style="padding: 20px !important;">
				<div class="courses-bx">
					<div class="dlab-media">
						<img src="<?= site_url() ?>public/assets/images/courses/course6.jpg" alt="">
					</div>
					<div class="dlab-info">
						<div class="dlab-title d-flex justify-content-between">
							<div>
